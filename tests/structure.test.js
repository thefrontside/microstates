...
describe('Structure', () => {
  ...
  it('can transition at the root node', function () {
    ...
    let {tree: nextTree, value: nextValue} = map(transition => (...args) => transition(tree, invoke)(...args), tree.data.transitions).authenticate('username', 'password');
  ...
  it('can transition at child nodes', function() {
    ...
    let { tree: nextTree, value: nextValue } = map(transition => (...args) => transition(tree, invoke)(...args), tree.children.user.children.lastName.data.transitions).set('make super');
  ...
  describe('A Parameterized Array', function() {
    ...
    it('can invoke transitions on the subtypes', function() {
      ...
      let transitions = map(transition => (...args) => transition(tree, invoke)(...args), tree.children[2].data.transitions);
    ...
    it('updates a tree to keep in sync with array transitions', function() {
      ...
      let transitions = map(transition => (...args) => transition(tree, invoke)(...args), tree.data.transitions);
  ...
  describe('A Parameterized Object', function() {
    ...
    it('can invoke transitions on the subtypes', function() {
      ...
      let transitions = map(transition => (...args) => transition(tree, invoke)(...args), tree.children.one.data.transitions);
